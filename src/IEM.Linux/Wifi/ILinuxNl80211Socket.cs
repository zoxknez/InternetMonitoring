...
public interface ILinuxNl80211Socket : IDisposable, IAsyncDisposable
{
    ...
    /// Invariants 259, 261: Reads cached kernel BSS results without triggering an RF scan, requiring explicit expectedWdev.
    /// </summary>
    Task<LinuxNl80211DumpResult<LinuxNl80211BssInfo>> DumpBssAsync(ushort nl80211FamilyId, int ifindex, ulong expectedWdev, CancellationToken cancellationToken = default);
