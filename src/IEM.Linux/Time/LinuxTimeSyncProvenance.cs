    ...
    string? FailureReason)
{
    ...
    /// </summary>
    public double? FrequencyPpm => FrequencyRaw.HasValue ? (double)FrequencyRaw.Value / 65536.0 : null;
    ...
    public static LinuxTimeSyncProvenance Unavailable(string failureReason) =>
        new(
            ...
            Unsynchronized: null,
            ClockError: null,
            LeapInsertPending: null,
            LeapDeletePending: null,
            LeapInProgress: null,
            LeapCompleted: null,
            PllEnabled: null,
            FllEnabled: null,
            PpsFrequencyDiscipline: null,
            PpsTimeDiscipline: null,
            PpsSignalPresent: null,
            PpsJitterExceeded: null,
            PpsWanderExceeded: null,
            PpsCalibrationError: null,
            NanosecondMode: null,
            OffsetRaw: null,
            FrequencyRaw: null,
            MaximumErrorMicroseconds: null,
            EstimatedErrorMicroseconds: null,
            PrecisionRaw: null,
            ToleranceRaw: null,
            TaiOffsetSeconds: null,
